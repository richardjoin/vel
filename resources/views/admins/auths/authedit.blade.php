                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form action="{{ url('admin/auth/'.$row->rank_id) }}" method="post" class="am-form tpl-form-line-form">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">权限</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="user-name"  name="rank_name" value="{{ $row->rank_name }}">
                                    </div>
                                </div>
